...
/**
 * Test for transaction MCNHT00101MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/MCNHT00101MXTest.xml" })
public class MCNHT00101MXTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(MCNHT00101MXTransactionTest.class);

	@Autowired
	private MCNHT00101MXTransaction transaction;
